...
export default function MuiTable() {
  ...
  React.useEffect(() => {
    if (products) {
      const newRows = products.map((product) => createData(product.id, product.name, product.category, product.amount, product.price, product.image));
      setRows(newRows);
    }
  }, [products]);
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <CustomTableCell align="right" style={{ display: "none" }}>
                      {row.id}
                    </CustomTableCell>
